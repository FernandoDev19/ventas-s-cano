                        ...
                        tabBarButton: (props) => {
                            ...
                            return (
                                <Pressable
                                    ...
                                    android_ripple={{ color: 'rgba(255, 87, 34, 0.15)', borderless: true }}
                                >
                                    <View style={{ borderRadius: 10 }} className={`${isActive ? "bg-primary" : ""} flex-col justify-center items-center rounded-lg py-4 w-max`}>
