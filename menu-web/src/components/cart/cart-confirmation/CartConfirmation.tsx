...
export default function CartConfirmation({ onNewOrder }: Props) {
  ...
  return (
    ...
    >
      <div className="bg-[#181818] p-6 md:p-8 rounded-t-2xl md:rounded-2xl h-max w-full max-w-[450px] shadow-2xl border border-gold/10 animate-in fade-in zoom-in-95 duration-200">
        <div className="text-center md:text-left">
          <div className="text-4xl mb-3 inline-block bg-emerald-100 text-emerald-800 py-3 px-4 rounded-full">
            ✓
          </div>
          <h2 className="font-playfair text-2xl md:text-3xl font-bold text-gold mt-2">
            ¡Pedido Confirmado!
          </h2>
          <p className="text-sm text-muted mt-1 mb-6">
            Pronto nos estaremos comunicando contigo para confirmar y proceder con tu pedido.
          </p>
        </div>

        <div className="bg-[#1e1e1e] rounded-xl p-3 border border-gold/10 mb-6">
